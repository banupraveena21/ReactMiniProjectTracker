...
const TraineeView = () => {
  ...
  // Always fetch only projects assigned to this trainee.
  const paramsWithAssigned = {
    ...filters,
    assigned_to: user.id,
  };
  ...
  return (
    <div className="p-4">
      <div className="mb-6">
        <h2 className="text-xl font-semibold mb-2">Your Projects & Filters</h2>
      ...
      <ProjectList filterParams={paramsWithAssigned} />
    </div>
  );
};
